    ...
    try {
      ...
      const imageLinks = await Promise.all(
        selectedFiles.map(async (file) => {
          ...
          const payload = { file: base64String, fileName: file.name };
      ...
      const response = await fetch(`/api/cars`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ ...data, images: imageLinks })
      });
  ...
  return (
    <div className="flex justify-center items-center py-4">
      <form
        ...
        className="space-y-6 p-6 md:p-10 w-full max-w-3xl border-2 rounded-lg"
      >
        <div>
